...
DOMAIN = "staging.shopback.sg"
COUNTRY = "SG"
API_GATEWAY = "https://api-app-staging.shopback.sg"
HEADERS = {
...
class DeviceUser(HttpUser):
    ...
    # GET /ecommerce/mobile/listing-groups/sboc_zalora_splws not in staging-sg
    # @task
    # def getEcommerceMobileListGroupsSbocZaloraSplws(l):
    #     l.client.get("%s/ecommerce/mobile/listing-groups/sboc_zalora_splws" % API_GATEWAY,
    #                  name="/ecommerce/mobile/listing-groups/sboc_zalora_splws", headers=l.headers)
    ...
    def getEcommerceMobileListGroupsSbocZaloraSplwsRecommendations(l):
        l.client.get("%s/ecommerce/mobile/listing-groups/sboc_ZALORAStoreCredit_30.00_2021-07-08_splws/recommendations" % API_GATEWAY,
                     name="/ecommerce/mobile/listing-groups/sboc_ZALORAStoreCredit_30.00_2021-07-08_splws/recommendations", headers=l.headers)

    # GET /feature-flag/app-reward/v1/configurations?variationId=60da9440b946c87d9ad1bf3d Done
    @task
    def getFeatureFlagAppRewardV1Configurations(l):
        l.client.get("%s/feature-flag/app-reward/v1/configurations?variationId=60d94b051412cbe4c0a6bd30" % API_GATEWAY,
                     name="/feature-flag/app-reward/v1/configurations?variationId=60d94b051412cbe4c0a6bd30", headers=l.headers)

    # GET /members/v3/me?type=mobile Done
    @task
    def getMembersV3Me(l):
        l.client.get("%s/members/v3/me?type=mobile" % API_GATEWAY,
                     name="/members/v3/me?type=mobile", headers=l.headers)
    
    # GET /mobile-content/v1/component/deals-manual/60e815956a46812b06760d24?offset=0&limit=69 not in staging-sg
    # @task
    # def getMobileContentV1ComponentDealsManual(l):
    #     l.client.get("%s/mobile-content/v1/component/deals-manual/60e815956a46812b06760d24?offset=0&limit=69" %
    #                  API_GATEWAY, name="/mobile-content/v1/component/deals-manual/60e815956a46812b06760d24?offset=0&limit=69", headers=l.headers)

    # GET /mobile-content/v1/powerscreens/mamypoko
    @task
    def getMobileContentV1PowerScreensSbocWomesale(l):
        l.client.get("%s/mobile-content/v1/powerscreens/mamypoko" %
                     API_GATEWAY, name="/mobile-content/v1/powerscreens/mamypoko", headers=l.headers)   

    #GET /mobile/configurations Done
    @task(2)
    ...
    # GET /orca/favorite/notification/product Done
    @task
    ...
    # GET /orca/favorite/product?includeGroup=1&page=1&sizePerPage=20 Done
    @task
    ...
    # POST /plo/appsflyer-data Done
    @task
    def postPloAppsflyerData(l):
        payload = {
            "appsflyerId":"1626948022347-7240978998368898323",
    ...
    #GET /v1/customer/accounts/self-deletion/request Done
    @task
    ...
    #GET /v1/inbox/count Done
    @task
    def getV1InbocCount(l):
        l.client.get("%s/v1/inbox/count" %
                     API_GATEWAY, name="/v1/inbox/count", headers=l.headers)    

    #GET /v1/merchants/19354 Done
    @task
    def getV1Merchants19354(l):
        l.client.get("%s/v1/merchants/19354" %
                     API_GATEWAY, name="/v1/merchants/19354", headers=l.headers)    

    #GET /v1/merchants/19354/deals Done
    @task
    def getV1Merchants19354Deals(l):
        l.client.get("%s/v1/merchants/19354/deals" %
                     API_GATEWAY, name="/v1/merchants/19354/deals", headers=l.headers)    

    #POST /v1/merchants/19354/redirect Done
    @task
    def postV1Merchants19354Redirect(l):
        payload = {
          "redirectData":{},
          "browser_name":"Mozilla/5.0 (Linux; Android 11; sdk_gphone_x86_arm Build/RSR1.201013.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36",
          "platformTrackingId":"48b9e5cd-8914-4712-928f-e77350a57327",
          "device_id":"c83c3e7199068c8c",
          "browser_platform":"Android",
          "advertising_id":"48b9e5cd-8914-4712-928f-e77350a57327",
          "appsflyerId":"1627649620525-6209905359910806443",
          "browser_version":"3.32.0-SNAPSHOT",
          "referrer_url":"store"
          }

        
        l.client.post("%s/v1/merchants/19354/redirect" %
                     API_GATEWAY, name="/v1/merchants/19354/redirect",json=(payload),  headers=l.headers)    
    
    #GET /v1/reward/vouchers/my-reward?offset=0&limit=20&sort=recentlyAdded Done
    @task
    ...
    #GET /v2/challenges?customSorts=codesFilter&statuses=NOT_STARTED,OPTED_IN,IN_PROGRESS,ACTION_COMPLETED,GOAL_COMPLETED&codes=SG_JUL_SBOC_WOMENSALE_ALL_LUCKYDRAW not in staging-sg
    @task
    ...
    #GET /v2/challenges/merchant-challenges?limit=1000 Done
    @task
    ...
    #GET /v2/challenges/partnership-challenges?limit=1000 Done
    @task
    ...
    #POST /v2/challenges/partnership-merchant-programs Done
    @task
    ...
    #GET /v2/challenges/uhs-challenges?offset=0&limit=3&sortBy=rank Done
    @task
    ...
    #GET /v2/reward/badges/vouchers-linked Not in staging-sg
    @task
    ...
    #Update after staging-sg 
    #GET //categories/level/0?country=SG&fields=name%2Cid%2CisLive%2Cpriority
    @task
    def getCategoriesLevel0(l):
        l.client.get("%s/categories/level/0?country=SG&fields=name,id,isLive,Cpriority"  %
                     API_GATEWAY, name="/categories/level/0?country=SG&fields=name,id,isLive,Cpriority", headers=l.headers)    
    ...
    def getPloMobileConfigurations(l):
        l.client.get("%s/plo/mobile/configurations?coordinates=1.2770321,103.8458774"  %
                     API_GATEWAY, name="/plo/mobile/configurations?coordinates=1.2770321,103.8458774", headers=l.headers)                         
        

#Only Staging SG
    @task
    def getMobileContentV1Components1(l):
        l.client.get("%s/mobile-content/v1/components/5e15925bab86161626b504c6?offset=0&limit=10&displayType=default"  %
                     API_GATEWAY, name="/mobile-content/v1/components/5e15925bab86161626b504c6?offset=0&limit=10&displayType=default", headers=l.headers)                         
    @task
    def getMobileContentV1Components2(l):
        l.client.get("%s/mobile-content/v1/components/5d688aa0e1047c26faf8aad1?offset=0&limit=10&displayType=default"  %
                     API_GATEWAY, name="/mobile-content/v1/components/5d688aa0e1047c26faf8aad1?offset=0&limit=10&displayType=default", headers=l.headers)                         
    @task
    def getMobileContentV1Components3(l):
        l.client.get("%s/mobile-content/v1/components/5d6b468aeebc18c5f1c4d507?offset=0&limit=3&displayType=default"  %
                     API_GATEWAY, name="/mobile-content/v1/components/5d6b468aeebc18c5f1c4d507?offset=0&limit=3&displayType=default", headers=l.headers)                         
    @task
    def getEcommerceMobileListings(l):
        l.client.get("%s/ecommerce/mobile/listings/LOAD_TEST_LIMITED"  %
                     API_GATEWAY, name="/ecommerce/mobile/listings/LOAD_TEST_LIMITED", headers=l.headers)                         
    @task
    def getEcommerceMobileListings2(l):
        l.client.get("%s/ecommerce/mobile/listings/LOAD_TEST_LIMITED/related"  %
                     API_GATEWAY, name="/ecommerce/mobile/listings/LOAD_TEST_LIMITED/related", headers=l.headers)                         
    @task
    def getEcommerceMobileListings3(l):
        l.client.get("%s/ecommerce/mobile/listings/LOAD_TEST_LIMITED/locations?lat=1.2770321&lon=103.8458774&limit=1"  %
                     API_GATEWAY, name="/ecommerce/mobile/listings/LOAD_TEST_LIMITED/locations?lat=1.2770321&lon=103.8458774&limit=1", headers=l.headers)                         
