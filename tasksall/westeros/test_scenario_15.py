...
class Scenario15(TaskSet):
    ...
    def task15(self):
        self.client.get(url=f'{common.BASE_URL}/',
                        ...
                        name='Scenario15 - /')
        self.client.get(url=f'{common.BASE_URL}/product/category/{self.category_name}/{self.category_id}',
                        cookies=self.cookies,
                        headers=common.HEADERS, name=f'Scenario15 - /product/category/{self.category_name}/{self.category_id}')
